...
printf '[{"name":"eDP-1","disabled":false},{"name":"OMARCHY-VIRTUAL-test-42","disabled":false}]' >"$p1_ctl/out"
p1_case 1 "an Omarchy virtual output is not a physical external"
printf '[{"name":"eDP-1","disabled":true},{"name":"OMARCHY-VIRTUAL-sunshine","disabled":false},{"name":"HDMI-A-1","disabled":false}]' >"$p1_ctl/out"
p1_case 0 "a real external beside an Omarchy virtual output is still true"
